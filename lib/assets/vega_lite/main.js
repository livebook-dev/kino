...
const markColor = "#6583ff";
const mainColors = ["#6583ff", "#ffa83f", "#e2474d", "#4aa148", "#2d4cdb", "#b7641f", "#bc1227", "#137518"];
const blues = ["#b2c1ff", "#8ba2ff", "#6583ff", "#3E64ff", "#2d4cdb", "#1f37b7", "#132593"];
const lightGray = "#e1e8f0";
const mediumGray = "#445668";
const darkGray = "#1c2a3a";
const darkestGray = "#0d1829"
