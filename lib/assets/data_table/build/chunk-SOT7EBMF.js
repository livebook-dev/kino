...
function assertNever(_never, msg) {
  return panic(msg != null ? msg : "Hell froze over");
}
...
function makeCSSStyle(theme) {
  ...
  }, theme.resizeIndicatorColor === void 0 ? {} : { "--gdg-resize-indicator-color": theme.resizeIndicatorColor }), theme.headerBottomBorderColor === void 0 ? {} : { "--gdg-header-bottom-border-color": theme.headerBottomBorderColor }), theme.roundingRadius === void 0 ? {} : { "--gdg-rounding-radius": `${theme.roundingRadius}px` });
}
...
function mergeAndRealizeTheme(theme, ...overlays) {
  const merged = __spreadValues({}, theme);
...
var ClickOutsideContainer = class extends React2.PureComponent {
  ...
  render() {
    const _a = this.props, { onClickOutside, isOutsideClick } = _a, rest = __objRest(_a, ["onClickOutside", "isOutsideClick"]);
    return React2.createElement("div", __spreadProps(__spreadValues({}, rest), { ref: this.wrapperRef }), this.props.children);
  }
};
...
react-dom/cjs/react-dom.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-SOT7EBMF.js.map
