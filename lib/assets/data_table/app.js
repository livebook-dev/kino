...
export function init(ctx, data) {
  ...
  function Navigation({ page, maxPage, limit }) {
    const prev = () => {
    ...
    return (
      <div className="navigation">
        ...
        <div className="pagination">
          ...
          <button class="pagination__button" onClick={next} disabled={page === maxPage}>
            <span>Next</span>
  ...
  function App() {
    ...
    const rows =
      content.page === content.max_page
        ? data.content.total_rows % content.limit
        : content.limit;
    ...
    return (
      <div className="app">
        <Navigation page={content.page} maxPage={content.max_page} limit={content.limit} />
        <DataEditor
