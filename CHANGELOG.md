...
* Removed `Kino.FS.file_spec/1`

## [v0.17.0](https://github.com/livebook-dev/kino/tree/v0.17.0) (2025-09-04)

This minor version brings no changes, it released for parity with Livebook v0.17.

## [v0.16.1](https://github.com/livebook-dev/kino/tree/v0.16.1) (2025-07-31)

### Added

* Added support for `Kino.JS.Live` events in `Kino.Control.subscribe/1` ([#505](https://github.com/livebook-dev/kino/pull/505))
